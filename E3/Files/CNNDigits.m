...
% layers = [imageInputLayer([28 28 1])
%   convolution2dLayer(5,12) % 12 more the better 32+64
%   reluLayer
%                             % More layers the better
%   maxPooling2dLayer(2,'Stride',2)
%   
%   convolution2dLayer(5,24) %24 %more the better 32+64
%   reluLayer  
%   
%   fullyConnectedLayer(10) % 10 more the better % 32 64 128
%   softmaxLayer
...
options = trainingOptions('sgdm','MaxEpochs',15, ... %15
